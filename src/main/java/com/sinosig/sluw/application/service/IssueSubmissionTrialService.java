...
public class IssueSubmissionTrialService {
    ...
    public Mono<String> answer(String input) {
        return Mono.fromCallable(() -> {
            ...
            String text = client.prompt(new Prompt(List.of(new SystemMessage(instructions),
    ...
    String validate(String input) {
        ...
        try {
            ...
            for (String name : List.of("currentErrors", "historyErrors", "lwmission", "lbmission", "lwnotepad", "autoallotbyerr")) {
            ...
            for (String name : List.of("currentErrors", "historyErrors", "lwmission", "lbmission", "lwnotepad")) {
